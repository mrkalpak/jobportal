    ...
    <div class="card candidate-card ms-auto me-auto p-4">
        ...
        <form class="upe-mutistep-form px-4" id="Upemultistepsform" method="POST" action="postdata.php" enctype="multipart/form-data">
            ...
            <div class="d-flex justify-content-center btn-row">
                ...
                <button type="submit" class="btn col-md-2 btn-primary-custom m-2" data-bs-toggle="modal" data-bs-target="#submitmodal1" onclick="triggerPostJob()" name="postjob" id="submitBtn" style="display: none;">Submit</button>
                ...
                <div class="modal-content">
                    <div class="modal-body px-5">
                        <div class="col-12  text-center">
                            <h5 class="">Submited Successful </h5>
                            <h6>Your Job Post is under review <br /> It will get Posted automatically after review. </h6>
                        </div>

                    </div>
                    <div class="my-3 text-center">
                        <a href="company-joblist.php">
                            <button type="submit" name="home" class="btn btn-primary-custom" data-bs-dismiss="modal">Done</button> </a>
                    </div>
                </div>
            </div>
        </div>
