    ...
    <div id="wrapper">
                                            ...
                                            <form class="upe-mutistep-form px-4" id="Upemultistepsform" action="">
                                                ...
                                                <div class="step">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto " id="preview-companyName">
                                                            Sanspost Pvt Ltd
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto preview-jobTitle" id="preview-jobTitle">
                                                            Software Developer
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto " id="preview-jobType">
                                                            Full Time
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto" id="preview-jobLocation">
                                                            Work From Office
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto" id="preview-salaryType">
                                                            Salary + Incentives
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto" id="preview-salaryRange">
                                                            80000 To 90000
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto" id="preview-minEdu">
                                                            10Th Pass
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto" id="preview-expRange">
                                                            0-10 Years
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto" id="preview-vacancy">
                                                            100
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto" id="preview-gender">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9" id="preview-jobDescription">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9" id="preview-jobResponsibility">
                                                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9" id="preview-additionalRequirements">
                                                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                                            Corporis nam nostrum excepturi, necessitatibus hic aliquam
                                                            veniam soluta.
                                                        </div>
        ...
        <script>
            function updateSummary() {
                ...
                var minEdu = document.getElementById('minedu').value;
                var minExp = document.getElementById('minyr').value;
                var maxExp = document.getElementById('maxyr').value;
                var vacancy = document.getElementById('vacancy').value;
                var gender = document.getElementById('gender').value;

                var jobDescription = document.getElementById('jd').value;
                var jobResponsibility = document.getElementById('jres').value;
                var additionalRequirements = document.getElementById('addreq').value;
                // alert("hello111");
                // Update the summary section
                document.getElementById('preview-companyName').innerText = companyName;
                document.getElementById('preview-jobTitle').innerText = jobTitle;
                document.getElementById('preview-jobType').innerText = jobType;
                document.getElementById('preview-jobLocation').innerText = jobLocation;
                document.getElementById('preview-salaryType').innerText = salaryType;
                document.getElementById('preview-salaryRange').innerText = minSalary + ' to ' + maxSalary;

                document.getElementById('preview-minEdu').innerText = minEdu;
                document.getElementById('preview-expRange').innerText = minExp + ' to ' + maxExp + ' years';
                document.getElementById('preview-vacancy').innerText = vacancy;
                document.getElementById('preview-gender').innerText = gender;

                document.getElementById('preview-jobDescription').innerText = jobDescription;
                document.getElementById('preview-jobResponsibility').innerText = jobResponsibility;
                document.getElementById('preview-additionalRequirements').innerText = additionalRequirements;
            }
        </script>
</body>
