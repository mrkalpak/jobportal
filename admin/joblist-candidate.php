                        ...
                        <div class="col" id="container-wrapper">
                            ...
                            <div class="row justify-content-between  bdr-custom-padding fs-4">
                                <div class="col-md-6" style="font-size: 40px;color: #4A0063;">
                                    Job Card Candidate List
                                </div>
                                <div class="col-md-6 div1" style="color:#F18101;">
                                    <i class="fa fa-home"></i>/ Job Card Candidate List
                                    <br>
                            ...
                            <?php
                                 while($row2 = $result2->fetch_assoc()) {
                                    ...
                                    // echo $today;
                                    $fairStatus="";
                                    if($today==$row2['applyTill'] || $today<$row2['applyTill']){
                                        $fairStatus="Active";
                                        $badege="success";
                                    }else{
                                        $fairStatus="Expired";
                                    ...
                                    <div class="row px-4 mb-2">
                                        <div class="col-md-9">
                                            '.$row2['jobTitle'].'<span class="badge ms-2 badge-'.$badege.' rounded-pill  ">'.$fairStatus.'</span>
                                                <br>
                                            <span style="color: #595959;">'.$row2['workingFrom'].' | Date: '.$row2['createdDate'].'</span> <br>
                                            </div>
                            ...
                            <div class="border border-1 candidate-card mt-3 rounded ms-auto me-auto p-3">
                                <div class="row">
                                    ...
                                    <div class="col d-flex justify-content-end">
                                        <a href="../assets/cardCandidateResume/'.$row['cardCandidateResume'].'" target="_blank" class="btn btn-sm btn-outline-secondary " download>
                                ...
                                <div class="row">
                                    <div class="col-md-8 row text-secondary">
                                        ...
                                        <div class="col-auto"> <i class="bi bi-geo-alt-fill"></i>'.$row['location'].' </div>
                                        <div class="col-auto">

                                            D.O.B : '.$row['birthdate'].'</div>
                                    </div>
                                </div>
